...
import { IconMapPin, IconQrcode, IconTicket } from "@tabler/icons-react";
...
export function Steps(){
    return (
        <View style={s.container}>
            ...
            <Step icon={IconTicket} title="Garanta vantagens perto de você" description="Ative cupons onde estiver, em diferentes estabelecimento."/>
        </View>
    )
}